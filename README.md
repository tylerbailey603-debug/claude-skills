...
/plugin install robinhood-trading@claude-code-skills            # Robinhood agentic-trading MCP (human-gated)
```
...
| **💰 Finance** | 5 | Financial analyst (DCF, budgeting, forecasting), SaaS metrics coach, business investment advisor, Robinhood agentic-trading MCP (human-gated trading loop) | [finance/](finance/) |
